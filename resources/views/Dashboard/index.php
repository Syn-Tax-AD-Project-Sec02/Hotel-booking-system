...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                <a class="navbar-brand brand-logo" href="{{ url('index') }}"><img src="{{ asset('dist/images/LOGO-UTM.png') }}" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="{{ url('index') }}"><img src="{{ asset('dist/images/logo-mini.svg') }}" alt="logo" /></a>
            </div>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                            <a class="dropdown-item" href="{{ url('pages/user/profile') }}">
                                <i class="mdi mdi-cached me-2 text-success"></i> Profile </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ url('pages/user/login') }}">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages/room/room.html">
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="{{assets('dist/vendors/js/vendor.bundle.base.js')}}"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="{{assets('dist/vendors/chart.js/chart.umd.js')}}"></script>
    <script src="{{assets('dist/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js')}}"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="{{assets('dist/js/off-canvas.js')}}"></script>
    <script src="{{assets('dist/js/misc.js')}}"></script>
    <script src="{{assets('dist/js/settings.js')}}"></script>
    <script src="{{assets('dist/js/todolist.js')}}"></script>
    <script src="{{assets('dist/js/jquery.cookie.js')}}"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="{{assets('dist/js/dashboard.js')}}"></script>
    <script src="{{assets('dist/js/chart.js')}}"></script>
    <script src="{{assets('dist/plugins/raphael/raphael.min.js')}}"></script>
    <script src="{{assets('dist/plugins/morris/morris.min.js')}}"></script>
    <script src="{{assets('dist/js/chart.morris.js')}}"></script>
