(function ($) {
  ...
  if ($("#traffic-chart").length) {
    ...
    new Chart(ctx, {
      type: 'doughnut',
      data: {
        labels: ['Single','Deluxe', 'Scholar','Suite' ],
        datasets: [{
          data: [30, 30, 40, 50],
          backgroundColor: [gradientStrokeBlue, gradientStrokeGreen, gradientStrokeRed, gradientStrokeViolet],
      ...
      options: {
        ...
        plugins: {
          legend: {
          display: true,
          position: 'right',   // Positions the labels to the left
          align: 'center',    // Centers the labels vertically
          padding: 20,        // Adds padding around the legend for better alignment
          labels: {
          boxWidth: 20,     // Adjust box size for better visibility
          padding: 15 
            }
          }
        }
