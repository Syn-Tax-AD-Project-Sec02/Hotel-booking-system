                                ...
                                <div class="card-body ">
                                                ...
                                                <div class="modal-content" style="background-color: white;">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('ScheduleListForm') }}" method="POST">
                                                            ...
                                                            <div class="mb-4">
                                                                <label for="FormControlName" class="form-label">Staff
                                                                    ID</label>
                                                                <select class="form-select"
                                                                    style="height:43px; font-size: 12px;"
                                                            ...
                                                            <div class="mb-4">
                                                                <label for="date_time"
                                                                    class="form-label">Date/Time</label>
                                                                <input type="datetime-local" class="form-control"
                                                                    name="date_time" placeholder="date_time"
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <select class="form-select"
                                                                    style="height:43px; font-size: 12px;" name="status"
                                                                    id="status">
                                                                    <option selected>Choose...</option>
                                    ...
                                    <table class="table table-hover">
                                      ...
                                      {{ $schedule->status == 'Completed' ? 'bg-success' : ($schedule->status == 'In Progress' ? 'bg-warning' : 'bg-secondary') }}">
                                                    ...
                                                    <td>
                                                        ...
                                                        {{-- <div class="dropdown-menu navbar-dropdown"
                                                            ...
                                                            <a class="dropdown-item" href="#"
                                                                ...
                                                                data-bs-target="#modalBookingU{{ $schedule->_id }}">
                                                            ...
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="event.preventDefault(); document.getElementById('deleteScheduleForm{{ $schedule->_id }}').submit();">
                                                                <i class="mdi mdi-delete me-2 text-danger"></i> Delete
                                                            </a>

                                                            <form id="deleteScheduleForm{{ $schedule->_id }}"
                                                                action="{{ route('deleteScheduleList') }}"
                                                ...
                                                <!-- Modal for Editing -->
                                                {{-- <div class="modal fade" id="modalBookingU{{ $schedule->_id }}"
                                                    tabindex="-1" aria-labelledby="modalBookingULabel"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="background-color: white;">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalBookingULabel">Edit
                                                                    Schedule</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('updateScheduleList') }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <input type="hidden" name="schedule_id"
                                                                    ...
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <select class="form-select"
                                                                            ...
                                                                            <option value="Housekeeper"
                                                                                {{ $schedule->services == 'Housekeeper' ? 'selected' : '' }}>
                                                                                Housekeeper</option>
                                                                            <option value="Maintenance"
                                                                                {{ $schedule->services == 'Maintenance' ? 'selected' : '' }}>
                                                                                Maintenance</option>
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            value="{{ $schedule->staffID }}" readonly>
                                                                    </div>

                                                                    <div class="mb-4">
                                                                        <label for="name" class="form-label">Staff
                                                                            Name</label>
                                                                        <input type="text" class="form-control"
                                                                            name="name" id="name"
                                                                            placeholder="Full Name"
                                                                            value="{{ $schedule->name }}" readonly>
                                                                    </div>

                                                                    <div class="mb-4">
                                                                        <label for="room_no" class="form-label">Room
                                                                            No</label>
                                                                        <input type="text" class="form-control"
                                                                            name="room_no" placeholder="Room No"
                                                                    ...
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <input type="datetime-local"
                                                                            ...
                                                                            value="{{ \Carbon\Carbon::parse($schedule->date_time)->format('Y-m-d\TH:i') }}"
                                                                    ...
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <select class="form-select"
                                                                            ...
                                                                            <option value="In Progress"
                                                                                {{ $schedule->status == 'In Progress' ? 'selected' : '' }}>
                                                                                In Progress</option>
                ...
                .then((data) => {
                    ...
                    data.forEach((staff) => {
                        staffSelect.innerHTML +=
                            `<option value='${JSON.stringify(staff)}'>${staff.staffID}</option>`;
                    });
                })
                .catch((error) => {
