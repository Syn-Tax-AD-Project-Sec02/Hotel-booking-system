...
<head>
    ...
    <link href="{{ asset('assets/css/bootstrap/../bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/bootstrap/js/bootstrap.bundle.min.js') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/bootstrap/css/bootstrap-reboot.min.css') }}" rel="stylesheet">
    <!-- endinject -->
    <!-- Layout styles -->
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('pages/ui-features/buttons.html') }}">Buttons</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('pages/ui-features/dropdowns.html') }}">Dropdowns</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('pages/ui-features/typography.html') }}">Typography</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="auth">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('pages/samples/login.html') }}"> Login </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('pages/samples/register.html') }}"> Register </a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <form>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <img src="{{ asset('assets/images/profile-img.jpg') }}" alt="Profile">
                                                    <div class="pt-2">
                                    ...
                                    <div class="tab-pane fade pt-3" id="profile-change-password">
                                        ...
                                        <form>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="confirmPassword" type="text" class="form-control" id="renewPassword">
                                                </div>
                                            </div>
