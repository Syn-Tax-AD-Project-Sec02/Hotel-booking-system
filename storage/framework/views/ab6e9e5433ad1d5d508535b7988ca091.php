                        ...
                        <div class="auth-form-light text-center p-5">
                            ...
                            <form id="loginForm" action="<?php echo e(route('login')); ?>" method="POST">
                                ...
                                <div class="my-2 d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="<?php echo e(url('user/ForgotPassword')); ?>" class="auth-link text-primary">Forgot password?</a>
                                </div>
                            </form>
...
<?php /**PATH C:\COMPUTER SCIENCE\SEM 3\Application Development\Scholars-Admin\resources\views/Admin/user/login.blade.php ENDPATH**/ ?>