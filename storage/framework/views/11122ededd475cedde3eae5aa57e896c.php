            ...
            <div class="col-xl-4 mx-auto"  >
              ...
              <div class=" logo lock ">
                ...
                <form action="<?php echo e(route('password.update')); ?>" method="POST">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" name="token" value="<?php echo e(old('token', request()->token)); ?>">
...
</html><?php /**PATH C:\COMPUTER SCIENCE\SEM 3\Application Development\Scholars-Admin\resources\views/Admin/user/resetPassword.blade.php ENDPATH**/ ?>