...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('dist/assets/css/bootstrap/../bootstrap-icons/bootstrap-icons.css" rel="stylesheet" ')); ?>">
    <link href="<?php echo e(asset('dist/assets/css/bootstrap/js/bootstrap.bundle.min.js" rel="stylesheet"')); ?>">
    <link href="<?php echo e(asset('dist/assets/css/bootstrap/css/bootstrap-reboot.min.css" rel="stylesheet"')); ?>">
    <!-- endinject -->
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
            <a class="navbar-brand brand-logo" href="<?php echo e(url('index')); ?>"><img src="<?php echo e(asset('dist/assets/images/LOGO-UTM.png')); ?>" alt="logo" /></a>
            <a class="navbar-brand brand-logo-mini" href="<?php echo e(url('index')); ?>"><img src="<?php echo e(asset('dist/assets/images/logo-mini.svg')); ?>" alt="logo" /></a>
        </div>
  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(url('admin/dashboard/index')); ?>">
        ...
        <div class="main-panel">
          <div class="pagetitle">
            <h1 style="padding-left: 50px; padding-top: 50px;"></h1>
      
          </div><!
        <!-- partial -->
        <section class="section profile" >
      <div class="rowProfile d-flex justify-content-center align-items-center" style="background: #f2edf3">
      ...
      <div class="tab-content">
          <div class="tab-pane fade show active pt-3" id="profile-change-password">
              ...
              <form id="changePasswordForm"  action="<?php echo e(url('changePass')); ?>" method="POST">
                        <!-- Change Password Form -->
                        <?php echo csrf_field(); ?>
                    <div class="row mb-3">
...
</html><?php /**PATH C:\Sem 3\AD\Hotel-booking-system\resources\views/Admin/user/changePass.blade.php ENDPATH**/ ?>